...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Django-StripePayments\Django-StripePayments-main\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Django-StripePayments\Django-StripePayments-main\venv\Scripts\deactivate.nu'
